...
${OBJECTDIR}/Savitch\ chapter\ 2\ problem\ 9.o: Savitch\ chapter\ 2\ problem\ 9.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Savitch\ chapter\ 2\ problem\ 9.o Savitch\ chapter\ 2\ problem\ 9.cpp

.NO_PARALLEL:${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 1.o
${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 1.o: gaddis\ chapter\ 3\ problem\ 1.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 1.o gaddis\ chapter\ 3\ problem\ 1.cpp
...
${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 10.o: gaddis\ chapter\ 3\ problem\ 10.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 10.o gaddis\ chapter\ 3\ problem\ 10.cpp
...
${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 20.o: gaddis\ chapter\ 3\ problem\ 20.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 20.o gaddis\ chapter\ 3\ problem\ 20.cpp

.NO_PARALLEL:${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 4.o
${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 4.o: gaddis\ chapter\ 3\ problem\ 4.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 4.o gaddis\ chapter\ 3\ problem\ 4.cpp

.NO_PARALLEL:${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 7.o
${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 7.o: gaddis\ chapter\ 3\ problem\ 7.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 7.o gaddis\ chapter\ 3\ problem\ 7.cpp

.NO_PARALLEL:${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 8.o
${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 8.o: gaddis\ chapter\ 3\ problem\ 8.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gaddis\ chapter\ 3\ problem\ 8.o gaddis\ chapter\ 3\ problem\ 8.cpp

.NO_PARALLEL:${OBJECTDIR}/gaddis\ chpater\ 3\ problem\ 3.o
${OBJECTDIR}/gaddis\ chpater\ 3\ problem\ 3.o: gaddis\ chpater\ 3\ problem\ 3.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gaddis\ chpater\ 3\ problem\ 3.o gaddis\ chpater\ 3\ problem\ 3.cpp
...
${OBJECTDIR}/savitch\ chpater\ 2\ problem\ 2.o: savitch\ chpater\ 2\ problem\ 2.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/savitch\ chpater\ 2\ problem\ 2.o savitch\ chpater\ 2\ problem\ 2.cpp
...
${OBJECTDIR}/savitch\ code\ E\ chapter\ 2\ problem\ 9.o: savitch\ code\ E\ chapter\ 2\ problem\ 9.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/savitch\ code\ E\ chapter\ 2\ problem\ 9.o savitch\ code\ E\ chapter\ 2\ problem\ 9.cpp
